                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Welcome to <br><strong class="text-dark">JeWePe Wedding Organizer</strong></p>    
                                    <h1 class="display-1 text-dark mb-4 animated zoomIn">We Are Here</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                <p class="fs-4 text-white animated zoomIn">Welcome to <br><strong class="text-dark">JeWePe Wedding Organizer</strong></p>    
                                <h1 class="display-1 text-dark mb-4 animated zoomIn">To Capture Your Moments</h1>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                <p class="fs-5 fw-medium fst-italic text-primary">Wedding Package Catalogues</p>
                <h1 class="display-6">Choose Your Wedding Package</h1>
            </div>
            <div class="row g-4">
                <?php
