            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Catalogues Management</h3>
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-6">
                      <h4 class="card-title">Wedding Package Catalogue</h4>
                    </div>
                    <div class="col-lg-6 text-right">
                      <a href="<?= base_url('admin/Katalog/add'); ?>" class="btn btn-primary">Add Data</a>
                    </div>
                    <div class="col-lg-4">
